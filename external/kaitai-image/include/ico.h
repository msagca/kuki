...
public:
  ...
  public:
    ...
    /**
         ...
         */
    uint8_t num_colors() const {
      return m_num_colors;
    }
    std::string reserved() const {
      return m_reserved;
    }
    /**
         * Number of color planes
         */
    uint16_t num_planes() const {
      return m_num_planes;
    }
    /**
...
public:
  ...
  /**
     ...
     */
  uint16_t num_images() const {
    return m_num_images;
  }
  std::vector<std::unique_ptr<icon_dir_entry_t>> *images() const {
    return m_images.get();
  }
  ico_t *_root() const {
    return m__root;
