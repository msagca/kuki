...
ico_t::ico_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent, ico_t *p__root)
...
ico_t::icon_dir_entry_t::icon_dir_entry_t(kaitai::kstream *p__io, ico_t *p__parent, ico_t *p__root)
  : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
  f_img = false;
