...
void main() {
        ...
        // NOTE: alpha forced to 1.0 -- see lit.frag for why (global alpha blending would otherwise discard this write whenever the ID's 4th byte is 0, i.e. for virtually all entity IDs).
